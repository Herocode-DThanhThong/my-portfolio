      ...
      {projects.map((project, idx) => (
        <div key={project.name}>
          ...
          <div className="flex my-6 gap-8">
            <div className="h-[300px] w-[700px] shadow-lg border rounded-md relative overflow-hidden hover:opacity-80 transition-all ease-in-out duration-300">
              <Link href={project.gitLink} target="_blank">
                <Image src={project.img} alt="my-project" fill />
              </Link>
            </div>
